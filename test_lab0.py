...
class T13_TestingGCD(unittest.TestCase):   
	...
	def test_testing_with_zero_and_number(self):       
		# testing with infinity       
		g1 = lab0.mathOps(0, 45)       
		print(g1)       
		self.assertEqual(g1.gcd(), 45)        
		print(repr(g1))       
		with self.assertRaises(Exception):                     
			g1.lcm()       
		print("\n")

class T14_TestingGCD(unittest.TestCase):   

	def test_testing_with_number_and_zero(self):       
		# testing with infinity       
		g1 = lab0.mathOps(45, 0)       
		print(g1)       
		self.assertEqual(g1.gcd(), 45)        
		print(repr(g1))       
		with self.assertRaises(Exception):                     
